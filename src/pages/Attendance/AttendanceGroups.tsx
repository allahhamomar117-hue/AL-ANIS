...
export default function AttendanceGroups() {
  ...
  const handleSelectHalaqa = (id: number) => {
    navigate(`/${params?.lang || "ar"}/attendance-groups/${id}`);
  };

  return (
    <div className="min-h-screen bg-white dark:bg-dark-light px-4 sm:px-8 py-6 mt-14 rtl transition-colors duration-300">
      ...
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        >
          <span className="text-base">
            {t("attendanceGroups.recordButton")}
          </span>
        </button>
      </div>
