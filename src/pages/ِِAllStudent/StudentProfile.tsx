...
function RecitationTab({ studentId }: { studentId: number }) {
  ...
  /*
   * النطاق معزول باتّجاه LTR‏ (U+2066 … U+2069).
   *
   * "225 → 226" مكتوبةٌ صحيحةً في الكود، لكنها تُعرض مقلوبةً "226 → 225"
   * داخل صفحة عربية: خوارزمية الاتجاه ثنائي الاتجاه تجعل السهم — وهو محرف
   * محايد — يرث اتّجاه الفقرة، فيُرتَّب الرقمان من اليمين إلى اليسار
   * فيسبق الأكبرُ الأصغر. والقارئ يفهم من ذلك تراجعاً في الحفظ.
   *
   * فالعزل لا تبديلُ السهم ولا قلبُ الطرفين: الطرفان يبقيان "من ← إلى"
   * كما في القاعدة، والعزل يضمن أن يُعرضا بهذا الترتيب مهما كانت لغة
   * الواجهة. والمحرفان عديما العرض فلا أثر لهما على الشكل.
   */
