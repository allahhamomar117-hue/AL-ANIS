...
export const config = {
  ...
  pointRules: {
    ...
    /**
     * إنجاز مقرَّر اليوم — قيمة ثابتة لا يحدّدها الأستاذ.
     *
     * ثباتها هو المقصود: لو تُركت للأستاذ لاختلف وزن المقرَّر الواحد بين
     * حلقة وأخرى، فصارت لوحة الصدارة تقيس سخاء الأستاذ لا اجتهاد الطالب.
     * وموضعها هنا لا في صفّ القاعدة ليبقى لكل إنجاز تفسيرٌ واحد مهما
     * تغيّرت القيمة لاحقاً.
     */
    assignmentDone: Number(process.env.POINTS_ASSIGNMENT ?? 25),
  },
};
